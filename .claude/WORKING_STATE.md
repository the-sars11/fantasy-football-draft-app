...
- **BACKLOG (deferred, tracked in CODE_REVIEW_2026-06.md):** giant-component extraction (live/review clients), sleeper-feed pickNoToManagerIdx consistency test (deferred - needs React hook test env). [DONE 2026-08-09: finding 13 connection-pill a11y, finding 7 sheet dedup, finding 5 broader test suite.]
