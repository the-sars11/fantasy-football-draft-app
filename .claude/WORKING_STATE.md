...
- **Status:** FF-310 COMPLETE — Claude Haiku generation wired. Alerts appear immediately with hardcoded fallback; message updates in-place when API responds. Next: FF-311 (owner history system).
