...
- **BACKLOG (deferred, tracked in CODE_REVIEW_2026-06.md):** sleeper-feed pickNoToManagerIdx consistency test (deferred - needs React hook test env); finding 8 (single dedup key), finding 11 (keeper numbering), finding 12 (per-pick edit/undo). [DONE 2026-08-09: finding 10 sheet-poll resilience, finding 9 giant-component extraction (live/review clients), finding 13 connection-pill a11y, finding 7 sheet dedup, finding 5 broader test suite.]
