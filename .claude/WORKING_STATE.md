...
- **BACKLOG (deferred, tracked in CODE_REVIEW_2026-06.md):** giant-component extraction (live/review clients), broader test suite, sheet/dedup hardening (finding 7 - needs the real Nasties sheet to confirm). [DONE 2026-08-09: connection-pill a11y size, finding 13.]
