...
- **Status:** FF-279 COMPLETE — FFI reads Auctioneer JSON export (localStorage + File System Access API) with 3-second hot-reload. Gated auction-only. Next: FF-280 BroadcastChannel.
