...
- **Anchor:** EA FC 25 + Linear ("EA FC cockpit") — methodology `:114`, `:102`. BUT G1.5 forbids one global anchor on every screen: each HERO screen (on-the-block card, multi-team board, TV hero, draft board, post-draft review) needs its OWN specific EA-FC surface, proven with real current screens on the Reference Board before any mockup.
