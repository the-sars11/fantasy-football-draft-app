<!-- DASHBOARD_STATUS
{
  ...
  "milestones": [
    ...
    { "name": "Simulation - Monte-Carlo engine (R10a) + grading/record/top-5/frequency/saved-runs data + DEC-1 bias (R10b) done; D5 pixels pending", "done": true },
  ...
  "nextItems": [
    ...
    "D5 [Sonnet, M]: NEXT BUILDABLE (unblocked by R10b 2026-08-17). Sim results + strategy-detail screens - build from keeper refs UI/mockup-strategy-detail/ + UI/mockup-post-draft-review/ (sim-results-v1.html superseded), consuming R10b data; winning-team-% bars + 5-roster carousel + no-em-dash narrative, all green -> steel-blue per UI/mockup-SHIELD-token-map.md.",
...
### D5 — Sim results screen `[Sonnet]` · class: output · UNBLOCKED 2026-08-17 (R10b done)
> - Class: WORKHORSE
