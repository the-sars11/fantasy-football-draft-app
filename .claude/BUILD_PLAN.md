<!-- DASHBOARD_STATUS
{
  ...
  "nextItems": [
    ...
    "D6 [Sonnet, L]: NEXT BUILDABLE (D5 done 2026-08-17). Live room visual + UX pass - new look + R11 UX gaps (FLEX tier row + T4/T5, collapsible My Team + on-block, surfaced strategy switcher + adaptive pivot, live target/avoid, live-updating values). Pairs with R11b.",
