<!-- DASHBOARD_STATUS
{
  ...
  "nextItems": [
    "UX-S1 + UX-S2 + UX-S2.5 done (plan + 4-tab nav skeleton verified desktop+mobile + per-screen layout blueprint = Section 9). NEXT: UX-S3 Research tab consolidation (Research landing + Player Browser + Draft Board with data layer fixed + tiers/targets; delete the Home hub) — build to Section 9 blueprints 9.1-9.4. See .claude/UX_OVERHAUL_2026-08.md.",
