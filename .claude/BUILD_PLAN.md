<!-- DASHBOARD_STATUS
{
  ...
  "nextItems": [
    "UX-S1 through UX-S5 done. UX-S5 shipped the Setup tab (blueprints 9.8-9.13): settings/page.tsx rebuilt as 5-section iOS-style nav list (LEAGUE/DRAFT/HISTORY/ACCOUNT/APPEARANCE); league-config-form.tsx Nasties defaults locked (QB:1 RB:1 WR:1 TE:1 FLEX:3 K:0 D/ST:1 Bench:5 IR:1, format always-auction, keepers/snake/sounds removed); Account sources from real Supabase getUser(); Demo Draft entry surfaced; back links added to /prep/configure + /draft/setup + /prep/runs; 'failed to fetch leagues' dead-end replaced with graceful empty + real deep-links. NEXT: UX-S6 — Review as its own tab, linked from Draft post-draft. See .claude/UX_OVERHAUL_2026-08.md Section 9.7.",
